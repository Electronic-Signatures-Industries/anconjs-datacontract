...
class HttpClient {
    constructor(apiConfig = {}) {
        ...
        this.request = (_a) => {
            var { body, secure, path, type, query, format = "json", baseUrl, cancelToken } = _a, params = tslib_1.__rest(_a, ["body", "secure", "path", "type", "query", "format", "baseUrl", "cancelToken"]);
...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryResource = (query, params = {}) => this.request(Object.assign({ path: `/Electronic-Signatures-Industries/anconprotocol/anconprotocol/resource`, method: "GET", query: query, format: "json" }, params));
    }
}
exports.Api = Api;
