...
exports.MsgClientImpl = exports.MsgFileResponse = exports.MsgFile = exports.MsgMetadataResponse = exports.MsgMetadata = exports.MsgMetadataTx = exports.MsgFileTx = exports.MsgFileMetadataResponse = exports.protobufPackage = void 0;
...
exports.MsgFileTx = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseMsgFileTx);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.MsgMetadataTx = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseMsgMetadataTx);
        message.sources = [];
        message.links = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
...
class MsgClientImpl {
    ...
    File(request) {
        const data = exports.MsgFile.encode(request).finish();
        const promise = this.rpc.request('ElectronicSignaturesIndustries.anconprotocol.anconprotocol.Msg', 'File', data);
        return promise.then((data) => exports.MsgFileResponse.decode(new minimal_1.Reader(data)));
    }
}
