...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryDocumentsAll = (query, params = {}) => this.request(Object.assign({ path: `/Electronic-Signatures-Industries/xdvnode/xdvnode/documents`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryDocuments = (id, params = {}) => this.request(Object.assign({ path: `/Electronic-Signatures-Industries/xdvnode/xdvnode/documents/${id}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryFile = (cid, params = {}) => this.request(Object.assign({ path: `/Electronic-Signatures-Industries/xdvnode/xdvnode/file/${cid}`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
//# sourceMappingURL=genrestclient.js.map