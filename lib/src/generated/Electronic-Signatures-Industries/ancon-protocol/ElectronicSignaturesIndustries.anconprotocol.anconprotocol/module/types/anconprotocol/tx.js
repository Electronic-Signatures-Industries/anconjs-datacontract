...
class MsgClientImpl {
    ...
    UpdateDataSource(request) {
        const data = data_union_1.MsgUpdateDataSource.encode(request).finish();
        const promise = this.rpc.request('ElectronicSignaturesIndustries.anconprotocol.anconprotocol.Msg', 'UpdateDataSource', data);
        return promise.then((data) => data_union_1.MsgUpdateDataSourceResponse.decode(new minimal_1.Reader(data)));
    }
    ...
    UpdateDataUnion(request) {
        const data = data_union_1.MsgUpdateDataUnion.encode(request).finish();
        const promise = this.rpc.request('ElectronicSignaturesIndustries.anconprotocol.anconprotocol.Msg', 'UpdateDataUnion', data);
        return promise.then((data) => data_union_1.MsgUpdateDataUnionResponse.decode(new minimal_1.Reader(data)));
    }
