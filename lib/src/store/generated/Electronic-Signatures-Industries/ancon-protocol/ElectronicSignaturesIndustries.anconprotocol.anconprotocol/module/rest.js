...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryReadDelegate = (id, params = {}) => this.request(Object.assign({ path: `/didregistry/delegates/${id}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryIdentifyOwner = (address, params = {}) => this.request(Object.assign({ path: `/didregistry/${address}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryGetAttributes = (address, params = {}) => this.request(Object.assign({ path: `/didregistry/${address}/attributes`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryGetDidKey = (hashcid, params = {}) => this.request(Object.assign({ path: `/didregistry/${hashcid}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryReadMetadataProof = (cid, path, params = {}) => this.request(Object.assign({ path: `/metadara/proof/${cid}/${path}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryReadWithPath = (cid, path, params = {}) => this.request(Object.assign({ path: `/metadata/${cid}/${path}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryCollection = (denomId, query, params = {}) => this.request(Object.assign({ path: `/nft/collections/${denomId}`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryDenoms = (query, params = {}) => this.request(Object.assign({ path: `/nft/denoms`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryDenom = (denomId, params = {}) => this.request(Object.assign({ path: `/nft/denoms/${denomId}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryOwner = (query, params = {}) => this.request(Object.assign({ path: `/nft/nfts`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryGetNft = (denomId, tokenId, params = {}) => this.request(Object.assign({ path: `/nft/nfts/${denomId}/${tokenId}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryReadRoyaltyInfo = (cid, price, params = {}) => this.request(Object.assign({ path: `/nft/royalty/${cid}/${price}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryResource = (cid, query, params = {}) => this.request(Object.assign({ path: `/resource/${cid}`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryWriteSchemaStoreResource = (body, params = {}) => this.request(Object.assign({ path: `/schemastore`, method: "POST", body: body, type: ContentType.Json, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryReadSchemaStoreResource = (cid, path, params = {}) => this.request(Object.assign({ path: `/schemastore/${cid}/${path}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
